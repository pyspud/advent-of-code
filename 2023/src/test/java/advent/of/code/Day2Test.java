...
class Day2Test {
    ...
    @Test
    void shouldFindMinimumSetOfBalls() {
        var expected = Set.of(new Red(20), new Blue(6), new Green(13));
        var game = Game.of("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red");
    ...
    @Test
    void shouldGetPowerOfGame1() {
        var game = Game.of("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green");
        assertThat(game.power()).isEqualTo(48);
    }
